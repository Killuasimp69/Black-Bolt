...
module.exports = client => {
    ...
    client.on('guildMemberAdd', async (member) => {
        ...
        let info = `${randomDescriptions[desc]} Welcome to Meme Arcade, a fast growing gaming server with memes, active chat and me (the server bot). Im so happy your here. To gain full access to the server just tap the "complete" button at the bottom or top of your screen.`
