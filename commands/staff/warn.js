                    ...
                    if (message.guild.id == "804323987106168842") {
                        await mongo().then(async (mongoose) => {
                            try {
                                ...
                                var yestime = "Last Sync: " + currentdate.getDate() + "/"
                                ...
                                const channelTemplate = new Discord.MessageEmbed()
                                    .setAuthor(`${memeberToWarn.displayName}`, user.displayAvatarURL({ format: 'jpg', dynamic: true }))
                                ...
                                if (warnResult) {
                                    return message.channel.send("Critcal Error. Please pardon this users warn")
                                } else {
                                ...
                                const newMoney = parseFloat(userResult.money) - parseFloat("100")
