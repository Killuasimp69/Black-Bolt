  ...
  callback: async (message, args, Discord, client, mongo) => {
    ...
    if (parseFloat(args[0]) >= serverResult.maxbetamt) {
      return message.channel.send(
        `You cannot bet more than ${serverResult.maxbetamt} BBC.`
      );
    }
    ...
    await mongo().then(async (mongoose) => {
      try {
        ...
        const embedForBetLose = new Discord.MessageEmbed()
          ...
          .setTitle(`Bet - LOSE`)
          .setThumbnail(
            "https://cdn.discordapp.com/attachments/974900127602974730/975309665908973598/ose.png"
          )
          .setColor("RED");
        ...
        const embedForBetWin = new Discord.MessageEmbed()
          ...
          .setTitle(`Bet - WIN`)
          .setThumbnail(
            "https://cdn.discordapp.com/attachments/974900127602974730/975310311072600064/you_win.png"
          )
          .setColor("GREEN");
        ...
        if (coinflip == 1) {
          ...
          if (!userResult || !userResult.money) {
            ...
            //yes enough money
            const newuseramt6 =
              parseFloat(userResult.money) - parseFloat(args[0]);
            await userSchema.findOneAndUpdate(
              {
                _id: user,
              },
